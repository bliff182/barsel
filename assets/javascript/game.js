...
function startGame() {
  ...
  lettersGuessedText.textContent =
    "Already Guessed: " + lettersGuessed.join(", ");
  ...
  document.onkeyup = function(event) {
    ...
    if (remainingLetters == 0) {
      ...
      // image of character is revealed -- WHY WON'T THIS RECOGNIZE THE RELATIVE PATH
      // if (currentWord == "batman") {
      //     var characterImage = document.getElementById("character-image").src="assets/images/characters/Batman_Vol_3_61_Textless.jpg";
      // }
    }
